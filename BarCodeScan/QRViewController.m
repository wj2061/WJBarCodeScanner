...
- (void)viewDidLoad {
    ...
    if (![self validateCamera]) {
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"没有摄像头或摄像头不可用" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [alertView show];
    }
...
//    _output.metadataObjectTypes =@[AVMetadataObjectTypeQRCode];
    ...
    qrRectView.transparentArea = CGSizeMake(250, 50);
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    if (stringValue.length == 15) {
        ...
        [[[UIAlertView alloc]initWithTitle:@"capture" message:stringValue delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil]show];
    }
}

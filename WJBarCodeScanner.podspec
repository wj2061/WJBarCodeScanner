#
#  Be sure to run `pod spec lint WJBarCodeScanner.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   It is a barCodeScanner used on iOS, which implement by Swift.
                   DESC

  s.homepage     = "https://github.com/wj2061/WJBarCodeScanner"
  ...
  s.source       = { :git => "https://github.com/wj2061/WJBarCodeScanner.git", :tag => "0.0.3" }
